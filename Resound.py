...
main_application.title('Audio Player')
main_application.geometry('600x600')
main_application.wm_iconbitmap('Media Player.ico')

status_bar_label = ttk.Label(main_application, text = 'Welcome To Audio Player', relief = GROOVE, borderwidth = 1, font = ('Times New Roman', 12, 'italic'))
...
music_player_icon = PhotoImage(file = 'icon/Media Player Resized.png')
...
#Buttons Invoking Functions Defined Above    
...
def aboutus_func():
    ...
    text = ttk.Label(about_us_dialog, text = 'Audio Player', font = ('Times New Roman', 28, 'bold'))
    text.pack(side = TOP)

    text1 = ttk.Label(about_us_dialog, text = 'Rizvi College of Engineering', font = ('Times New Roman', 14))
    text1.pack(side = TOP)

    text2 = ttk.Label(about_us_dialog, text = '\nResound Audio Player is a free open source platform for \nAudios made by: -\nUzair Petiwala\nFaiz Shaikh\nHuzaifa Siddiqui\nReSound  Player can read almost all music files and \nformats\n', font = ('Times New Roman', 12))
    text2.pack(side = TOP)
